package com.rngproduction.integrationCoreOW.models.apiModels.responses.AcceptPayRsApi;
...
public class AcceptPayRsApiModel implements ApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AcceptPayRsApiModel that)) return false;
