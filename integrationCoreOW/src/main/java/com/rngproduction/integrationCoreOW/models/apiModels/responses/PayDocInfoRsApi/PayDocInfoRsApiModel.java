package com.rngproduction.integrationCoreOW.models.apiModels.responses.PayDocInfoRsApi;
...
public class PayDocInfoRsApiModel implements ApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PayDocInfoRsApiModel that)) return false;
