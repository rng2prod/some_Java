package com.rngproduction.integrationCoreOW.models.apiModels.responses.ExecPayRsApi;
...
public class ExecPayRsApiModel implements ApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExecPayRsApiModel that)) return false;
