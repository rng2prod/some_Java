package com.rngproduction.integrationCoreOW.models.extModels.requests.PayDocAcceptRqPutExt;
...
public class PayDocAcceptRqPutExtModel implements ExtRequest {
    ...
    private PayDocAcceptRqPutExtModel_Header header = new PayDocAcceptRqPutExtModel_Header();
    @JacksonXmlProperty(localName = "/* hidden string */")
    private PayDocAcceptRqPutExtModel_Body body = new PayDocAcceptRqPutExtModel_Body();
    ...
    public PayDocAcceptRqPutExtModel_Header getHeader() {
        return header;
    }

    public void setHeader(PayDocAcceptRqPutExtModel_Header header) {
        this.header = header;
    }

    public PayDocAcceptRqPutExtModel_Body getBody() {
        return body;
    }

    public void setBody(PayDocAcceptRqPutExtModel_Body body) {
        this.body = body;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PayDocAcceptRqPutExtModel that)) return false;
    ...
    public String toString() {
        return "PayDocAcceptRqPutExtModel{" +
                "soapenv='" + soapenv + '\'' +
                ", ns='" + ns + '\'' +
                ", ns4='" + ns4 + '\'' +
                ", ns5='" + ns5 + '\'' +
