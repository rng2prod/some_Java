package com.rngproduction.integrationCoreOW.models.extModels.requests.AcceptPayRqPutExt;
...
public class AcceptPayRqPutExtModel implements ExtRequest {
    ...
    private AcceptPayRqPutExtModel_Header header = new AcceptPayRqPutExtModel_Header();
    @JacksonXmlProperty(localName = "/* hidden string */")
    private AcceptPayRqPutExtModel_Body body = new AcceptPayRqPutExtModel_Body();
    ...
    public AcceptPayRqPutExtModel_Header getHeader() {
        return header;
    }

    public void setHeader(AcceptPayRqPutExtModel_Header header) {
        this.header = header;
    }

    public AcceptPayRqPutExtModel_Body getBody() {
        return body;
    }

    public void setBody(AcceptPayRqPutExtModel_Body body) {
        this.body = body;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AcceptPayRqPutExtModel that)) return false;
